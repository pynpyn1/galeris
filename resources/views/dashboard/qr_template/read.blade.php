...
@section('title', 'QR Template Manage')
@section('name_header', 'QR Template Manage')
    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <a href="{{ route('manage.qr_template.create') }}" class="btn btn-primary">
                    Add QR Template
                </a>
            </div>
    ...
    <script>
        $(document).ready(function() {
            $('#serverSideTable').DataTable({
                ...
                responsive: true,
                ajax: {
                    url: "{{ route('manage.qr_template.data') }}",
                    type: "GET"
                },
                columns: [{
                        data: 'DT_RowIndex',
            ...
            $('#serverSideTable').on('click', '.delete-qr-template-btn', function() {
                let id = $(this).data('id');

                Swal.fire({
                    title: "Apakah Anda Yakin?",
                    text: "QR Template ini akan dihapus!",
                    icon: "warning",
