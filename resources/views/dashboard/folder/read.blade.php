    ...
    <section class="section">
        <div class="card">
            <div class="card-header">
                <a href="{{ route('manage.folder.create') }}" class="btn btn-primary">Add Folder</a>
            </div>
            <div class="card-body">
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#serverSideTable').on('click', '.delete-folder-btn', function() {
                var folderId = $(this).data('id');

                Swal.fire({
                    title: "Apakah Anda Yakin?",
                    text: "Anda tidak akan dapat mengembalikan folder ini!",
                    icon: "warning",
