    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            <div class="col-12 col-md-10">
                ...
                <div class="mb-5">
                    <h1 class="fw-bold text-dark mb-3">Cetak Lembar A4</h1>
                    <p class="text-muted fs-5 lh-base">
                        Kartu cetak sendiri kami adalah cara tercepat untuk meminta tamu Anda mengunggah foto dan video
                        mereka.
                        Unduh lembaran A4 siap pakai, cetak, dan gunting.
                    </p>
                </div>
                    ...
                    @empty
                        <div class="col-12">
                            <div class="text-center py-5 bg-light rounded-4 border border-dashed">
                                <p class="text-muted fs-5 mb-0">Tidak ada template yang tersedia sekarang</p>
                            </div>
                        </div>
                    @endforelse
                </div>
