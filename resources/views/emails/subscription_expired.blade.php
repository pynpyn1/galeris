...
<head>
    ...
    <style>
        ...
        .amount {
            ...
            /* Palette Utama */
            font-size: 24px;
            /* Sedikit lebih kecil dari harga agar muat jika nama paket panjang */
            font-weight: 800;
            display: block;
            margin-top: 8px;
        }
            ...
            <td align="center" style="padding: 30px 0;">
                ...
                <div class="content">
                    ...
                    <div class="card">
                        ...
                        <p>
                            Masa aktif langganan Anda telah berakhir. Saat ini Anda tidak lagi memiliki akses ke fitur
                            premium.
                        </p>

                        <div class="summary-box">
                            <span class="date">Paket Berakhir</span>
                            <span class="amount">{{ $packageName }}</span>
                        </div>

                        <p>
                            Untuk melanjutkan layanan dan menikmati fitur kami kembali, silakan beli paket baru melalui
                            aplikasi.
                        </p>
